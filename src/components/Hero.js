              ...
              <header>
                  <nav className="items-center pt-3 pl-2 mx-auto max-w-screen-xl sm:pl-4 sm:flex sm:space-l-6">
                      ...
                      <ul className="py-4 flex-1 items-center flex space-x-3 sm:space-x-6 sm:justify-end">
                          <li>
                            <Link  href="/signin">
                              <button href="./signin/page" className="px-5 py-3 text-white text-bold duration-150 bg-[#B165BC] rounded-full hover:bg-indigo-500 active:bg-indigo-700 flex items-center">
                                  Log In
                              </button>
                            </Link>
                          </li>
